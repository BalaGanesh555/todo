...
import RadioButton, {value} from '../../containers/Forms/demos/RadioButton'
      ...
      <Fragment>
        ...
        >
          ...
          <ListItemSecondaryAction>
           ...
           {/* { (this.state.value) === 'High'?
                    <Typography variant="button" className={classes.text}>High</Typography>
            :
                    <Typography variant="button" className={classes.divider}>Low</Typography>
            } */}
